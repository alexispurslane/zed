...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions only apply to the Xenomorphic native agent and don’t extend to external agents connected through external agents.";
