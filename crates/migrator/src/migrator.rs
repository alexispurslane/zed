...
mod tests {
    ...
    #[test]
    fn test_migrate_builtin_agent_servers_removes_stale_keys() {
        assert_migrate_with_migrations(
            &[MigrationType::Json(
    ...
    "agent_servers": {
        ...
        "codex": {
            ...
            Some(
                // Stale builtin keys (gemini, claude, codex) are removed since the
                // ACP registry they mapped to no longer exists.
                // The text-based JSON updater leaves an empty object with preserved whitespace.
                r#"{
    "agent_servers": {
    ...
    #[test]
    fn test_migrate_builtin_agent_servers_already_empty() {
        assert_migrate_with_migrations(
            &[MigrationType::Json(
                migrations::m_2026_02_25::migrate_builtin_agent_servers_to_registry,
            )],
