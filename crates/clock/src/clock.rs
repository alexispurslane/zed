...
impl ReplicaId {
    ...
    /// thread's ID hash. The same thread ID always maps to the same replica ID.
    pub fn for_agent_thread(thread_id: u64) -> Self {
        let offset = (thread_id % (Self::AGENT_REPLICA_RANGE as u64)) as u16;
