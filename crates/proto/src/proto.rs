...
messages!(
    ...
    // User/Contact/Follow - still referenced by client/workspace crates
    // TODO: Remove when Phase 8 (client crate cleanup) is complete
    (Follow, Foreground),
    ...
    // Contact - still referenced by client crate
    // TODO: Remove when Phase 8 (client crate cleanup) is complete
...
request_messages!(
    ...
    // User/Contact/Follow - still referenced, TODO: remove in Phase 8
