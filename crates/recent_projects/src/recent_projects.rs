...
use xenomorphic_actions::{OpenDevContainer, OpenRecent, OpenRemote};
...
pub fn init(cx: &mut App) {
    #[cfg(target_os = "windows")]
    cx.on_action(|open_wsl: &xenomorphic_actions::wsl_actions::OpenFolderInWsl, cx| {
            ...
            cx.spawn_in(window, async move |workspace, cx| {
                ...
                if paths.is_empty() {
                    let message = indoc::indoc! { r#"
                        ...
                        Please note that Xenomorphic currently does not support opening network share folders inside wsl.
                    "#};
    ...
    #[cfg(target_os = "windows")]
    cx.on_action(|open_wsl: &xenomorphic_actions::wsl_actions::OpenWsl, cx| {
        let create_new_window = open_wsl.create_new_window;
        with_active_or_new_workspace(cx, move |workspace, window, cx| {
